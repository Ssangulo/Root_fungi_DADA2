...
kable(
  tab_s3,
  col.names = c("Filtering level", "OTUs (all)", "Samples (all)", "OTUs (root)", "Samples (root)"),
...
# generates Tables S9–S10, and exports Figures 2a and S5–S6 as PNG files.
...
kable(
  ...
  digits = 3,
  col.names = c("Order", "Genus", "n OTUs", "w.beta paramo", "w.beta subparamo", "% enr. paramo", "% enr. subparamo"),
